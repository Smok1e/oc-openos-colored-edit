-- Modified by https://github.com/Smok1e
...
local startBackground, startForeground = gpu.getBackground (), gpu.getForeground ()
...
gpu.setBackground (startBackground)
gpu.setForeground (startForeground)
